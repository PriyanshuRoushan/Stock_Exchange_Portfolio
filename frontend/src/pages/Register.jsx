...
export default function Register() {
  ...
  return (
    <main className="min-h-screen flex flex-col md:flex-row bg-surface text-on-surface">
      {/* Left Side: Interactive Sign-up Form */}
      <section className="w-full md:w-1/2 flex flex-col min-h-screen relative p-container-padding lg:p-16">
        ...
        <div className="max-w-[440px] w-full mx-auto my-12">
          <div className="mb-8">
            <h1 className="text-headline-lg font-headline-lg text-on-surface mb-2 font-bold text-3xl">Create your account</h1>
            <p className="text-body-md font-body-md text-on-surface-variant">Start consolidating your investments today.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-label-md font-label-md text-on-surface-variant mb-2" htmlFor="name">Full Name</label>
              <input 
            ...
            <div className="relative">
              <label className="block text-label-md font-label-md text-on-surface-variant mb-2" htmlFor="password">Password</label>
              <input 
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <label className="text-body-md text-on-surface-variant text-sm" htmlFor="terms">
